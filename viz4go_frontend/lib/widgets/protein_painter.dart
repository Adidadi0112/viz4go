...
class ProteinPainter extends CustomPainter {
  ...
  ProteinPainter(this.positions, this.connections, this.nodeIndex,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Offset startFix = const Offset(30, 25);
    Offset endFix = const Offset(30, 25);

    for (var protein in connections.entries) {
